...
bindUserData();
      ...
      function bindUserData() {
        ...
        var AddRow =
          ...
          "<td class='td-data'><select id='ddlstatus'><option value='Software Department'>Software Department</option><option value='Sales Department'>Sales Department</option></select></td>" +
          "<td class='td-data'>" +
      ...
      function showEditRow(UserID) {
        ...
        trdata[0].innerHTML =
          ...
          '"/>';
        trdata[1].innerHTML =
          '<input name="txtname" id="txtname" value="' + userName + '"/>';
        trdata[2].innerHTML =
          '<input name="txtemail" id="txtemail" value="' + useremail + '"/>';
        if (userGender == "male") {
          trdata[3].innerHTML =
        ...
        if (userStatus == "Software Department") {
          trdata[4].innerHTML =
            '<select id="ddlstatus"><option value="Software Department">Software Department</option><option value="Sales Department">Sales Department</option></select>';
        } else {
          trdata[4].innerHTML =
            '<select id="ddlstatus"><option value="Sales Department">Sales Department</option><option value="Software Department">Software Department</option></select>';
        }
